...
import { t } from '../../utils/i18n'; // adjust path if needed
        ...
        <div className='flex flex-col gap-5 py-3'>
            ...
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-1">
                    <h2 className='font-semibold'>{t('security.email')}</h2>
            ...
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-1">
                    <h2 className='font-semibold'>{t('security.password')}</h2>
                    <p className='text-[#000000b0] text-sm'>{t('security.passwordInfo')}</p>
                </div>
            ...
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-1">
                    <h2 className='font-semibold'>{t('security.twoStep')}</h2>
                    <p className='text-[#000000b0] text-sm'>{t('security.twoStepInfo')}</p>
                </div>
                <button className='text-[#00000047] text-sm font-semibold border border-[#00000047] rounded-lg py-1 px-2'>
                    {t('security.addVerification')}
                </button>
            </div>

            <div className="">
                <h2 className='text-lg font-bold'>{t('security.support')}</h2>
                ...
                <div className="flex flex-col gap-5 py-3">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-1">
                            <h2 className='font-semibold'>{t('security.changeJob')}</h2>
                            <p className='text-[#000000b0] text-sm'>{t('security.jobInfo')}</p>
                        </div>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-1">
                            <h2 onClick={() => setPopupType('delete')} className='font-semibold text-red-500 cursor-pointer'>{t('security.deleteAccount')}</h2>
                            <p className='text-[#000000b0] text-sm'>{t('security.deleteInfo')}</p>
                        </div>
                    </div>
            ...
            <RequestPopUp
                ...
                title={t('popup.emailTitle')}
                message={t('popup.emailMessage')}
                actionText={t('popup.sendRequest')}
            ...
            <RequestPopUp
                ...
                title={t('popup.jobTitle')}
                message={t('popup.jobMessage')}
                actionText={t('popup.sendRequest')}
            ...
            <PasswordPopUp
                ...
                onClose={() => setPopupType(null)}
                icon={password_icon}
                title={t('popup.passwordTitle')}
                message={t('popup.passwordMessage')}
