        ...
        <div className='flex flex-col justify-center items-center mx-auto'>
            <div className="flex items-center w-full px-4 mt-5 max-w-[1400px]">
                ...
                <div className="flex-1 flex justify-end">
                    <button onClick={handleDownload} className="flex items-center me-10 mt-5 gap-4 bg-[#2c6472] px-8 py-2 rounded-md">
            ...
            <div className='w-full flex gap-5 p-5 mt-3 ms-2'>
                ...
                <div className='w-[600px]'>
                        ...
                        <div className="flex gap-2 flex-wrap mb-3">
                            {workExperience.content.map((exp, idx) => (
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs border rounded-full ${selectedCompanyIdx === idx
                    ...
                    {/* Education */}
                    <div className={`border rounded-md px-4 mb-4 py-3 bg-white text-sm text-gray-700 relative ${activeSection === 'education' ? 'border-[#2c6472]' : 'border-gray-300'
                        }`}>
                        <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex gap-2 flex-wrap mb-3">
                            {education.content.map((edu, idx) => (
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs border rounded-full ${selectedEducationIdx === idx
                                            ? 'bg-[#2c6472] text-white border-[#2c6472]'
                                            : 'bg-white text-gray-700 border-gray-300'
                                        }`}
                                >
                        ...
                        <div className="flex gap-2 flex-wrap mb-3">
                            {projects.content.map((proj, idx) => (
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs border rounded-full ${selectedProjectIdx === idx
                                            ? 'bg-[#2c6472] text-white border-[#2c6472]'
                                            : 'bg-white text-gray-700 border-gray-300'
                                        }`}
                                >
